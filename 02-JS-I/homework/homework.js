...
function esPositivo(numero) {
  ...
  if (numero<0){console.log ("es negativo")}else console.log ("es positivo");
}
...
function esVocal(letra){
  ...
  //Escribe tu código aquí
  if (letra.length===1 && letra==="a" || letra==="e" || letra === "i" || letra === "o" || letra ==="u") {console.log ("es vocal")}else console.log ("dato incorrecto");
}
